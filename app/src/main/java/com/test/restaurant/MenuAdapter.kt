...
/*    fun getFoodDetails(): List<FoodDetails>? {
        return foodDetails
    }*/
}
/*
class MenuAdapter(val foodDetails: List<FoodDetails>?, var context: Context) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val food = foodDetails!![position]
        holder.txt_food.text = foodDetails[position].getFood_title()
        holder.txt_desc.text = foodDetails[position].getFood_desc()
        holder.txt_price.text = "€ " + foodDetails[position].getPrice()
        holder.txt_count.text = "" + foodDetails[position].getCount()
        ...
        holder.txt_mins.setOnClickListener {
            ...
            holder.txt_count.text = "" + food.getCount()
            if (context is SecondActivity) {
                (context as SecondActivity).updateprice()
            } else if (context is MainActivity) {
                (context as MainActivity).updateItem()
